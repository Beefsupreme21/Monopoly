...
<div class="bg-gray-50 border border-gray-200 p-10 rounded max-w-lg mx-auto mt-24">
    ...
    <form method="POST" action="/" enctype="multipart/form-data">
        ...
        <input x-on:click="property = true, chance = false, communityChest = false" type="radio" id="html" name="type" value="HTML" checked="checked">
        <label for="html">Property</label><br>

        <input x-on:click="property = false, chance = true, communityChest = false" type="radio" id="css" name="type" value="CSS">
        <label for="css">Chance</label><br>

        <input x-on:click="property = false, chance = false, communityChest = true" type="radio" id="javascript" name="type" value="JavaScript">
...
</div><?php /**PATH C:\xampp\Projects\Monopoly\resources\views/components/create-properties.blade.php ENDPATH**/ ?>