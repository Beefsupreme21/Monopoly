...
<?php $component->withAttributes([]); ?>
    <div class="flex p-10 w-2/3 m-auto">
        <div class="bg-gray-50 border border-gray-200 p-10 rounded max-w-lg m-auto">
            ...
            <form method="POST" action="/chance/<?php echo e($chanceCard->id); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input
                        ...
                        value="<?php echo e($chanceCard->amount); ?>"
                    />
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input
                        ...
                        name="goToProperty"
                        placeholder="$35"
                        value="<?php echo e($chanceCard->goToProperty); ?>"
                    />
...
<?php endif; ?><?php /**PATH C:\xampp\Projects\Monopoly\resources\views/chanceCard/edit.blade.php ENDPATH**/ ?>