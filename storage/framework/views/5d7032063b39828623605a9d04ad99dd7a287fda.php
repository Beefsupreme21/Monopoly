        ...
        <body>
            <div class="bg-slate-700">
                <div class="flex justify-between">
                    ...
                    <a href="<?php echo e(route('chance.create')); ?>"><span class="font-bold text-lg text-white hover:underline">Create new Chance Card</span></a>
                    <a href="<?php echo e(route('properties.create')); ?>"><span class="font-bold text-lg text-white hover:underline">Create new prop</span></a>
                ...
                <nav class="flex justify-evenly items-center pb-6">
                    ...
                    <a href="<?php echo e(route('chance.index')); ?>"><span class="font-bold text-lg text-white hover:underline">Chance</span></a>
                    <a href="<?php echo e(route('communityChest.index')); ?>"><span class="font-bold text-lg text-white hover:underline">Community Chest</span></a>
