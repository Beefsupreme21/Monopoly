...
<div class="grid gap-0 grid-cols-11 grid-rows-10 border-2 border-gray-200 text-center">
    ...
    <label class="border-b hover:bg-sky-700" for='30'>30</label>
    ...
    <label class="border-b hover:bg-sky-700" for='31'>31</label>

    <input class="hidden" type='radio' value='18' name='position' id='18'/>
    <label class="border-b hover:bg-sky-700" for='18'>18</label>
    <span class="col-span-9 bg-gray-300"></span>
    <input class="hidden" type='radio' value='32' name='position' id='32'/>
    <label class="border-b hover:bg-sky-700" for='32'>32</label>

    <input class="hidden" type='radio' value='17' name='position' id='17'/>
    <label class="border-b hover:bg-sky-700" for='17'>17</label>
    <span class="col-span-9 bg-gray-300"></span>
    <input class="hidden" type='radio' value='33' name='position' id='33'/>
    <label class="border-b hover:bg-sky-700" for='33'>33</label>

    <input class="hidden" type='radio' value='16' name='position' id='16'/>
    <label class="border-b hover:bg-sky-700" for='16'>16</label>
    <span class="col-span-9 bg-gray-300"></span>
    <input class="hidden" type='radio' value='34' name='position' id='34'/>
    <label class="border-b hover:bg-sky-700" for='34'>34</label>
    
    <input class="hidden" type='radio' value='15' name='position' id='15'/>
    <label class="border-b hover:bg-sky-700" for='15'>15</label>
    <span class="col-span-9 bg-gray-300"></span>
    <input class="hidden" type='radio' value='35' name='position' id='35'/>
    <label class="border-b hover:bg-sky-700" for='35'>35</label>

    <input class="hidden" type='radio' value='14' name='position' id='14'/>
    <label class="border-b hover:bg-sky-700" for='14'>14</label>
    <span class="col-span-9 bg-gray-300"></span>
    <input class="hidden" type='radio' value='36' name='position' id='36'/>
    <label class="border-b hover:bg-sky-700" for='36'>36</label>

    <input class="hidden" type='radio' value='13' name='position' id='13'/>
    <label class="border-b hover:bg-sky-700" for='13'>13</label>
    <span class="col-span-9 bg-gray-300"></span>
    <input class="hidden" type='radio' value='37' name='position' id='37'/>
    <label class="border-b hover:bg-sky-700" for='37'>37</label>

    <input class="hidden" type='radio' value='12' name='position' id='12'/>
    <label class="border-b hover:bg-sky-700" for='12'>12</label>
    <span class="col-span-9 bg-gray-300"></span>
    <input class="hidden" type='radio' value='38' name='position' id='38'/>
    <label class="border-b hover:bg-sky-700" for='38'>38</label>

    <input class="border-b hidden" type='radio' value='11' name='position' id='11'/>
    <label class="border-b hover:bg-sky-700" for='11'>11</label>
    <span class="col-span-9 bg-gray-300"></span>
    <input class="hidden" type='radio' value='39' name='position' id='39'/>
    <label class="border-b hover:bg-sky-700" for='39'>39</label>
    ...
    <label class="border-l hover:bg-sky-700" for='9'>9</label>

    <input class="hidden" type='radio' value='8' name='position' id='8'/>
    <label class="border-l hover:bg-sky-700" for='8'>8</label>

    <input class="hidden" type='radio' value='7' name='position' id='7'/>
    <label class="border-l hover:bg-sky-700" for='7'>7</label>

    <input class="hidden" type='radio' value='6' name='position' id='6'/>
    <label class="border-l hover:bg-sky-700" for='6'>6</label>

    <input class="hidden" type='radio' value='5' name='position' id='5'/>
    <label class="border-l hover:bg-sky-700" for='5'>5</label>

    <input class="hidden" type='radio' value='4' name='position' id='4'/>
    <label class="border-l hover:bg-sky-700" for='4'>4</label>

    <input class="hidden" type='radio' value='3' name='position' id='3'/>
    <label class="border-l hover:bg-sky-700" for='3'>3</label>

    <input class="hidden" type='radio' value='2' name='position' id='2'/>
    <label class="border-l hover:bg-sky-700" for='2'>2</label>

    <input class="hidden" type='radio' value='1' name='position' id='1'/>
    <label class="border-l hover:bg-sky-700" for='1'>1</label>

    <input class="hidden" type='radio' value='0' name='position' id='0'/>
    <label class="border-l hover:bg-sky-700" for='0'>0</label>
</div>